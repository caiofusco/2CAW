...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($senha !== $confirmar_senha) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO usuarios (nome, email, matricula, senha, tipo_usuario) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param("sssss", $nome, $email, $matricula, $senha_hash, $tipo);
        ...
        <div class="auth-container">
            <div class="auth-card">
                ...
                <form class="auth-form" method="post">
                    ...
                    <div class="mb-3">
                        <div class="btn-group" role="group" aria-label="Seleção de Tipo de Usuário">
                            <input type="radio" class="btn-check" name="profile" id="aluno" value="aluno" autocomplete="off" required>
                            <label class="btn btn-outline-primary" for="aluno">Aluno</label>

                            <input type="radio" class="btn-check" name="profile" id="professor" value="professor" autocomplete="off" required>
                            <label class="btn btn-outline-primary" for="professor">Professor</label>

                            <input type="radio" class="btn-check" name="profile" id="administrador" value="admin" autocomplete="off" required>
